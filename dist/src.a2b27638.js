...
var ClientsAccounts = _interopRequireWildcard(require("./account-business"));
...
var ClientsElement = _interopRequireWildcard(require("./client-business"));
...
var ClientsAccounts = _interopRequireWildcard(require("./client-list-business"));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "15382" + '/');
